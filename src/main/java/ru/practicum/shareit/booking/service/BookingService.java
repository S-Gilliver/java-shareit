...
public interface BookingService {
    ...
    List<BookingDtoOut> getAllByBooker(Long bookerId, String state, int from, int size);

    List<BookingDtoOut> getAllByOwner(Long ownerId, String state, int from, int size);
}
